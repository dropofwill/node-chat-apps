...
mod.send_data_factory = function(socket, port, address) {
...
mod.valid_port = function(remote_info, valid_port) {
...
mod.bind_socket = function(socket, port, set_broadcast, callback) {
